...
public class CloneLLWithRandomPointer2 {

    Node head;

    public CloneLLWithRandomPointer2() {
    }

    public CloneLLWithRandomPointer2(int data) {
    ...
    public static void main(String[] args){
        ...
        CloneLLWithRandomPointer2 list = new CloneLLWithRandomPointer2(5);
